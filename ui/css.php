...
.env-check-details{display:none;margin-top:10px}
...
.form table{width:100%;background:#fff;border:1px solid #e0e0e0;border-radius:4px;overflow:hidden}
.form th,.form td{padding:12px 15px;border-bottom:1px solid #eee}
.form th{background:#f8f9fa;font-weight:600;width:150px}
.form tr:last-child th,.form tr:last-child td{border-bottom:none}
